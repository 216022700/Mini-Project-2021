...
namespace SamsonSchoolSuppliers
{
    public partial class ClientLogin : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                string clientEmail = TextBox1.Text.Trim();
                ...
                string result = queryManager.TwoFieldExistance("client", "clientEmail", clientEmail, "clientPassword", hashedStaffPassword);
                if (result == "Fields Exist.")
                    Response.Redirect("#");
                else
                {
                    Label1.ForeColor = System.Drawing.Color.Red;
                    Label1.Text += "Invalid Email and/or Password.";
                }
